...
public enum SignalFormat {
    ...
    FORMAT_8(8) {
         ...
         */
        @Override
        public int[] convertToSamples(byte[] source, HeaderSignal[] headerSignals) {
    ...
    FORMAT_16(16) {
         ...
         * 16-bit two’s complement amplitude stored the least significant byte first.
    ...
    SignalFormat(int bitResolution) {
     ...
     */
    public abstract int[] convertToSamples(byte[] source, HeaderSignal[] headerSignals);
